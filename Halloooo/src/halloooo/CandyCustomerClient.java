 ...
 * [dk.candycrushers.model.customer]<br>
 * USAGE:
 * <pre>
 *        CandyCustomerClient client = new CandyCustomerClient();
 ...
 * @author Thomas
 */
public class CandyCustomerClient {
    private WebResource webResource;
    private Client client;
    private static final String BASE_URI = "http://localhost:8080/CandyREST/webresources";

    public CandyCustomerClient() {
        com.sun.jersey.api.client.config.ClientConfig config = new com.sun.jersey.api.client.config.DefaultClientConfig();
        client = Client.create(config);
        webResource = client.resource(BASE_URI).path("dk.candycrushers.model.customer");
    }
