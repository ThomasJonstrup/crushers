...
/**
 * Jersey REST client generated for REST resource:CurrencyFacadeREST
 * [entity.currency]<br>
 * USAGE:
 * <pre>
 *        CurrencyRateClient client = new CurrencyRateClient();
...
public class CurrencyRateClient {
    ...
    private static final String BASE_URI = "http://localhost:8080/CurrencyRates/webresources";

    public CurrencyRateClient() {
        com.sun.jersey.api.client.config.ClientConfig config = new com.sun.jersey.api.client.config.DefaultClientConfig();
        client = Client.create(config);
        webResource = client.resource(BASE_URI).path("entity.currency");
    }
